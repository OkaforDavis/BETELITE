// Dream League Soccer (DLS) Game Module
class DLSGame {
    constructor() {
        this.name = 'Dream League Soccer';
        this.gameId = CONFIG.GAMES.DLS;
        this.currentMatch = null;
        this.initialized = false;
    }

    async init() {
        console.log('Initializing Dream League Soccer');
    ...
    async startMatch(tournament) {
        // DLS specific match initialization
        this.currentMatch = {
            id: tournament.id,
            game: this.gameId,
            status: 'starting',
    ...
    async sendForDetection() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log('Detection started for DLS match');
            }
        } catch (error) {
