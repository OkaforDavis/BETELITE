...
// Remove the COMING LIVE overlay from watch promos
content = content.replace(/<div class="watch-promo-badge">COMING LIVE<\/div>/g, '<div class="watch-promo-badge" style="background:var(--red);">LIVE NOW</div>');
content = content.replace(/<div class="watch-promo-badge">COMING SOON<\/div>/g, '<div class="watch-promo-badge" style="background:var(--red);">LIVE NOW</div>');
...
// 5. Safely replace buildAds and buildTicker to add setTimeout and fix onclick
content = content.replace(
...
console.log('Site made safely LIVE.');
